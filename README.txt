...
food              - недача еды после 3 часов сзадержания
...
Ключевые слова отобраны из частотных списков получившихся лемм.
...
Результаты суммирования выпадают при наведении на сайте https://ivan-hilckov.github.io/police-arbitrariness-map/ при наж
...
Также ведется работа над улучшением классификации и привлечением более адекватной модели)
